...
dlmwrite('phi_final_training_inverse.txt',phi_onecolumn(:,1:Ntraining), 'precision',10);
save('phi_final_training_inverse.mat','phi_final_training')
...
dlmwrite('phi_final_training_test_inverse.txt',phi_onecolumn(:,(Ntraining-Ntesting)+1:Ntraining), 'precision',10);
save('phi_final_training_test_inverse.mat','phi_final_training_test')
...
dlmwrite('phi_final_testing_inverse.txt',phi_onecolumn(:,(Ntraining+1):(Ntraining+Ntesting)), 'precision',10);
save('phi_final_testing_inverse.mat','phi_final_testing')
